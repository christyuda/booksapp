...
class TopPicksCell extends StatelessWidget {
  ...
  TopPicksCell({required this.index});
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<BookProvider>(
      builder: (context, bookProvider, child) {
        if (index < bookProvider.topPicksArr.length) {
          final Book book = bookProvider.topPicksArr[index];
          ...
          return CircularProgressIndicator(); // Atau widget pengganti jika indeks tidak valid
        }
      },
    );
  }
